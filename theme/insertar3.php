...
// Insertar los datos en la base de datos (usando la nueva tabla certificados3)
$stmt = $conn->prepare("INSERT INTO certificados3 (solicitante, referencia, denominacion, codigo, fecha, fecha_registro) VALUES (?, ?, ?, ?, ?, NOW())");
